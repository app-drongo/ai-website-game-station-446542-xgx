...
const DEFAULT_NAVBAR = {
  ...
  navHomeText: 'Home',
  navHomeHref: '/',
  navAboutText: 'PC Gaming',
  navAboutHref: '#pc-gaming',
  navServicesText: 'Console Gaming',
  navServicesHref: '#console-gaming',
  navPortfolioText: 'Games',
  navPortfolioHref: '#games',
  navContactText: 'Community',
  navContactHref: '#community',
} as const;
