...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'The ultimate gaming destination for PC and console enthusiasts. Experience cutting-edge gaming technology, discover new titles, and connect with a community of passionate gamers worldwide.',
  contactEmail: 'hello@gamestation.com',
  contactPhone: '+1 (555) GAME-NOW',
  contactAddress: '123 Gaming Blvd, Tech District',
  newsletterTitle: 'Gaming Updates',
  newsletterPlaceholder: 'Enter your gamer email',
  newsletterDisclaimer:
    'Get the latest gaming news, releases, and exclusive offers. No spam, unsubscribe anytime.',
  section1Title: 'Gaming',
  section2Title: 'Community',
  section3Title: 'Support',
  section4Title: 'Legal',
  copyrightText: '© 2024 GameStation. All rights reserved.',
  madeWithText: 'by gaming enthusiasts',
  ...
  linkFeatures: 'PC Gaming',
  linkFeaturesHref: '#pc-gaming',
  linkPricing: 'Console Gaming',
  linkPricingHref: '#console-gaming',
  linkTemplates: 'Game Library',
  linkTemplatesHref: '/games',
  linkIntegrations: 'Streaming',
  linkIntegrationsHref: '/streaming',
  linkApi: 'Gaming API',
  linkApiHref: '/api',
  linkDocumentation: 'Setup Guides',
  ...
  linkHelpHref: '/help',
  linkCommunity: 'Gaming Community',
  linkCommunityHref: '/community',
  linkTutorials: 'Gaming Tutorials',
  linkTutorialsHref: '/tutorials',
  linkWebinars: 'Live Streams',
  linkWebinarsHref: '/streams',
  linkCaseStudies: 'Pro Gaming',
  linkCaseStudiesHref: '/pro-gaming',
